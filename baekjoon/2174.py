...
def sol():
    ...
    for op in ops:
        ...
        current_y, current_x, current_dir = get_robot_status(robot_num, robot_status)
        ...
        if op == "L":
            ...
            set_robot_status([current_y, current_x, current_dir], robot_num, robot_status)
...
def get_robot_status(robot_num, robot_status):
    return robot_status[robot_num][0], robot_status[robot_num][1], robot_status[robot_num][2]
